...
namespace SampleProject.IntegrationTests.SeedWork
{
    public class TestBase
    {
        ...
        {
            const string connectionStringEnvironmentVariable = "ASPNETCORE_SampleProject_IntegrationTests_ConnectionString";
            ...
            EmailsSettings = new EmailsSettings { FromAddressEmail = "aykut@aykutaktas.net"};
